...
# # load_dotenv()
# # CONFIG_API_URL = f"{os.getenv('API_URL')}/api/all_stores_config"
...
# #             "http://217.18.55.92:5173",
# #             "http://217.18.55.92:5000"
# #         ],
...
#             "http://217.18.55.30:5173",
#             "http://217.18.55.30:5000"
#         ],
#         "methods": ["GET", "POST", "PUT", "DELETE", "OPTIONS"],
#         "allow_headers": ["Content-Type", "Authorization"],
#         "supports_credentials": True,
    ...
    if zone_rows and ze_cols:
        ...
        if not df.empty:
            ...
            if direction_col and zone_col:
                ...
                # only entry events for footfall
                ...
                # gender per day (uses gender column on zone_events if present)
